...
A comprehensive guide on deploying and managing cloud-native applications using AWS, Kubernetes, and DevSecOps tools.

![gif1](assets/project-cicd-flow.gif)
...
- [Step 4: Deploy the Jump host Server(EC2) using Terraform on GitHub Actions.](#step-4-deploy-the-jump-host-serverec2-using-terraform-on-github-actions)
- [Step 5: Configure the Jump host.](#step-5-configure-the-jump-host)
...
- [Step 8: Set up Snyk Token for the app code pipeline.](#step-8-set-up-snyk-token-for-the-app-code-pipeline)
...
In this comprehensive project, we will walk through the process of setting up a robust Three-Tier architecture on AWS using Kubernetes, DevOps best practices, and security measures. This project aims to provide hands-on experience in deploying, securing, and monitoring a scalable application environment.

### Project Overview:
In this project, we will cover the following key aspects:

1. IAM User Setup: Create an IAM user on AWS with the necessary permissions to facilitate deployment and management activities.
2. Infrastructure as Code (IaC): Use Terraform and AWS CLI to set up the Jump host server (EC2 instance) on AWS.
3. GitHub Actions Configuration: configure essential GitHub actions on GitHub Actions workflow, including Snyk, Docker, Sonarqube, Terraform, Kubectl, AWS CLI, and Trivy.
...
- Basic familiarity with Kubernetes, Docker, CI-CD pipelines, GitHub Actions, Terraform, and DevOps principles.

### Step 1: SSH Exchange between a local computer and GitHub account
...
ssh-keygen
```
![Screenshot  AM](assets/Screenshot%20of%20key%20generation.png)
...
Go to the Settings of your GitHub account from a profile section.
Go to Access Section on the left **SSH and GPG Keys** and **New SSH key**. Give a title and paste the content of key.pub

![Screenshot  AM](assets/add-new-ssh-key-GitHub.png)
...
```
#### Clone the application code and IaC repositories 
```
git clone https://GitHub.com/danieltikamori/reactjs-quiz-app.git
```
```
git clone https://GitHub.com/danieltikamori/iac_code_reactjs_quiz_app.git
```
```
cd iac_code_reactjs_quiz_app
...
git config core.sshCommand "ssh -i ~/.ssh/key -F /dev/null"
```
![Screenshot  AM](assets/mkdir-git-clone.png)
...
![Screenshot  AM](assets/Screenshot%20of%20creating%20a%20new%20GitHub%20repository.png)

   - Name your repository **iac_code_reactjs_quiz_app**, set it to public or private, and click "Create repository."

![Screenshot  AM](assets/Screenshot%20of%20a%20newly%20created%20GitHub%20repository%20with%20setup%20instructions.png)
...
![Screenshot  AM](assets/change-the-remote-url-of-the-local-repository.png)


3. **Push Your Code to the New Repository:**

  - Rename the Local master branch to main (GitHub standard):
    ```     
    git branch -M main
    ```
...
![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/a60e8c35-2547-46aa-89be-11f1b97bfd12)


Click on Create user

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/be98197b-79d3-43eb-9999-a178dd8346fc)
...
![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/0a72f551-2f90-447d-9ba0-1784b8a937c5)

Click on Next.

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/318f6640-5346-41e1-bcde-f7efdf73e2fb)

Click on Create user

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/d9dc1a65-de40-4d74-a311-089638b5cc58)
...
![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/28d6572c-1d0f-4877-a8af-f3ccfbfaaba5)



Select the **Command Line Interface (CLI)** then select the checkmark for the confirmation and click on Next.

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/cab6e1b5-bc3a-40cf-b09d-d11db190bd81)
...
![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/283cc9fb-31d7-4220-93b3-15d93cb45b4f)


#### Create GitHub Repo Secret for iac repository
...
![Screenshot  AM](assets/adding-secrets-and-variables-in-GitHub-repository.png)
...
![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/17093658-686c-457e-8a1d-b4004b7e9986)


6. **Repeat 1-5 for app code repository:**

#### Create S3 Bucket for Terraform State files 
Create S3 bucket for the terraform state file. Add the bucket name in the iac_code_reactjs_quiz_app repo secret. Name: **BUCKET_TF**, Value: **<your-bucket-name>**

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/47797825-5ca9-4564-841b-b8a30c77ddac)


#### Create key pair 
Create key pair for SSHing into the Jump host in .pem format and download it in your local machine

![Screenshot  AM](https://GitHub.com/cloudcore-hub/Kubernetes-DevSecOps-CI-CD-Project/assets/88560609/03b85d83-6c8d-4047-9fc0-12a16fe48410)
...
### Step 4: Deploy the Jump host Server(EC2) using Terraform on GitHub Actions
```
cd ~/Desktop/project/iac_code_reactjs_quiz_app
```
...
Now, in the **variables.tf** you can change some of the variable **region**, **vpc-name**, **ami_id**, **instance_type**, but you must replace the **instance_keypair** with the Pem File name as you have for your Pem file. Provide the Pem file name already created on AWS.
...
Now, connect to your Jump host-Server by clicking on Connect.
...
### Step 5: Configure the Jump host
...
To allow the cluster to integrate with AWS IAM for assigning IAM roles to Kubernetes service accounts, enhancing security and management.
...
![Screenshot 2024-02-28 at 1 13 55 PM](assets/sonar-cloud-generate-token.png)
...
### Step 8: Set up Snyk Token for the app code pipeline
...
![Screenshot 2024-03-13 at 2 00 50 PM](assets/snyk-generate-token.png)
...
Create the namespace for the EKS Cluster. In your Jump host server terminal 
...
Now, we need to access our Prometheus and Grafana consoles from outside the cluster.
...
In Connection, paste your **Prometheus-LB-DNS:9090**
...
Once you click on the Dashboard. You will see a lot of Kubernetes components monitoring.
...
Note: 6417 is a unique ID from Grafana that is used to Monitor and visualize Kubernetes Data
...
ArgoCD will deploy all the applications in the kubernetes-manifest folder
...
### Step 14: Clean up
From your Jump host server terminal run
```
eksctl delete cluster --name=quizapp-eks-cluster --region=us-east-1
```

In your iac_code_reactjs_quiz_app terminal, 
...
Cloudcore Hub:
https://www.youtube.com/@CloudcoreHub

Original project repository:
https://github.com/cloudcore-hub/reactjs-quiz-app
